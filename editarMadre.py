...
"}")
    ...
    def retranslateUi(self, Dialog_editar_padres):
        ...
        self.label_nre.setText(QCoreApplication.translate("Dialog_editar_padres", u"NRE del hijo:", None))
        self.lineEdit_nre.setPlaceholderText(QCoreApplication.translate("Dialog_editar_padres", u"Introduce el NRE del hijo...", None))
